...
public class MaterialEntity
{
    ...
    public MaterialEntity(int id, String title, String materialType, String unit, double cost, int packCount, int stockCount, int minCount, String desc, String imagePath)
    {
        ...
        try {
            image = new ImageIcon(ImageIO.read(MaterialEntity.class.getClassLoader().getResource(imagePath))
                    .getScaledInstance(50, 50, Image.SCALE_DEFAULT));
        } catch (Exception e) {
            try {
                image = new ImageIcon(ImageIO.read(MaterialEntity.class.getClassLoader().getResource("picture.png"))
                        .getScaledInstance(50, 50, Image.SCALE_DEFAULT));
            } catch (Exception e1) {
            }
        }
