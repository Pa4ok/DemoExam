...
public class App {
    /*
        ...
        World
        метод updateWorld перебирает всех сущностей и вызывает у них функцию update
        после этого в конце обновления (мира) из списка должны удаляться все сущности у которых health <= 0
        метод getEntitiesInRegion принимает либо координаты и радиус либо сущность (и берет у нее коррдинаты)
        и возвращает список сущнсотей в радиусе от этих координат
