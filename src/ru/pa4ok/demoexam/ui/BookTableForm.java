...
public class BookTableForm extends BaseForm
{
    ...
    private void initBoxes()
    {
        ...
        pageSortBox.addItem("Любое количество");
        pageSortBox.addItem("до 10 страниц");
        pageSortBox.addItem("от 11 до 100 страниц");
        pageSortBox.addItem("от 101 до 1000 страниц");
        pageSortBox.addItem("больше 1000 страниц");
